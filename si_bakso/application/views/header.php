<html>
    <head>
        ...
        <title>Sistem Informasi Managemen Restoran</title>
  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu">
      ...
      <li class="treeview">
        ...
        <a href="<?php echo site_url('Absen')?>">
          <i class="fa fa-money"></i> <span>Absen</span>
        </a>
        <a href="<?php echo site_url('Gudang')?>">
          <i class="fa fa-briefcase"></i> <span>Gudang</span>
        </a>
        <a href="<?php echo site_url('Produk')?>">
          <i class="fa fa-user"></i> <span>Produk</span>
        </a>
        <a href="<?php echo site_url('Transaksi')?>">
          <i class="fa fa-truck"></i> <span>Transaksi</span>
        </a>
      </li>
    </ul>
  </section>
